...
#define STOP_RECORD_TIMER(name) {                           \
    ...
    for (int ch = 0; ch < nChannels; ch++){
        ...
        gpuErrchk( cudaMemcpy(dev_input_data, input_data, 
            N * sizeof(cufftComplex), cudaMemcpyHostToDevice));
        ...
        */
        ...
        gpuErrchk( cudaMemcpy(dev_impulse_v, impulse_data, 
            impulse_length * sizeof(cufftComplex), cudaMemcpyHostToDevice));
        ...
        */
        ...
        cufftExecC2C(plan, dev_input_data, dev_input_data, CUFFT_FORWARD);  //input
        cufftExecC2C(plan, dev_impulse_v, dev_impulse_v, CUFFT_FORWARD);    //impulse
